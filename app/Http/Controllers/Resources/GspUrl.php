...
class GspUrl extends Resource
{
	public static $notFoundPhrase = 'GSP URL not found';
	...
	{
		$gsp = request()->gsp;
		return $this->respondWithPagination($gsp->gspUrls()->paginate(static::getPerPage()));
	}
	...
	{
		$model = $this->findResource($id, request()->gsp, 'gspUrls');
    ...
    {
        $this->model = new \App\Models\GspUrl();
    }
}
