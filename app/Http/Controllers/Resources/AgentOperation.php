...
class AgentOperation extends Resource
{
	public static $notFoundPhrase = 'Agent Operation not found';
	...
	{
		$model = $this->findResource($id, request()->agent, 'operations');
    ...
    {
        $this->model = new \App\Models\AgentOperation();
    }
}
