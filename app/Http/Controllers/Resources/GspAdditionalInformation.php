...
class GspAdditionalInformation extends Resource
{
	public static $notFoundPhrase = 'GSP Additional Information not found';
	...
	{
		$gsp = request()->gsp;
		return $this->respondWithPagination($gsp->gspAdditionalInfo()->paginate(static::getPerPage()));
	}
	...
	{
		$model = $this->findResource($id, request()->gsp, 'gspAdditionalInfo');
    ...
    {
        $this->model = new \App\Models\GspAdditionalInfo();
    }
